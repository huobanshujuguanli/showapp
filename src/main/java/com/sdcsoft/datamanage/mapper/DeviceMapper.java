...
public interface DeviceMapper {
    ...
    @Select("select DeviceSuffix from Device where EnterpriseId = #{orgId}")
    List<String> getDeviceNoByEnterpriseId(@Param("orgId") int orgId);

    @Select("select * from Device where DeviceSuffix = #{deviceNo}")
    Device getDeviceByDeviceNo(@Param("deviceNo") String deviceNo);
